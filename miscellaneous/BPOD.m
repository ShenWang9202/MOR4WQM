function ReducedsystemMatrix = BPOD(systemMatrix,sampleTime,numofSteps,r,EnergyPercentageGoal_BPOD)
...
% same time;
iteration = 4;
[U1,Sig1,V1] = rsvd1(Hankel1,300,iteration,0); % Randomized SVD
