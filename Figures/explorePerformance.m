function explorePerformance(Method,Yfull,OutputError_L1,i_output,delta_t,r_vector,tInMin,Network)
...
plotOutputError_r(Method,OutputError_L1_inputPerspective,delta_t,r_vector,tInMin,Network)