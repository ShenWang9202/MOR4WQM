function [UeachIntervalforEPANET,U_C_B_eachStep,PreviousSystemDynamicMatrix] = ObtainControlAction_Reduced(CurrentValue,IndexInVar,aux,ElementCount,x_estimated,PreviousValue,POD_Steps)
...
[UeachIntervalforEPANET,U_C_B_eachStep] = ApplyMPC(A,B,C,Np,x_estimated,PreviousValue,aux,delta_t);