...
DeltaU_Junction2 =  DeltaU_Junction2 * flowRate_B * ConfigurationConstants.Gallon2Liter;
...
IndexofUeachMin = [];
for i = 1:Hq_min
    IndexofUeachMin = [IndexofUeachMin floor(i * ConfigurationConstants.MinInSecond/delta_t)+1];
end
