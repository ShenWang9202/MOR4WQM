...
[A_J, B_J] = ConstructMatrixForJunction_D_Decay(CurrentFlow,MassEnergyMatrix,flipped,ElementCount,IndexInVar,q_B, A_J, B_J, aux, JunctionDecayRate_step);
...
SensorIndex = aux.SensorIndex;
C = generateC(TargetedPipeID,LinkID,NumberofSegment4Pipes,Pipe_CStartIndex,ElementCount,nx,SensorIndex);
%C = speye(nx,nx);
