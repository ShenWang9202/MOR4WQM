...
switch Network
    case 1 % 3-node network
        NumberofSegment4Pipes = 150;%ConfigurationConstants.NumberofSegment;
    ...
    case 7
        ...
        NumberofSegment4Pipes(NumberofSegment4Pipes>300) = 300;
    ...
    case 9 % net3 network
        ...
        %
        %NumberofSegment = 150;%ConfigurationConstants.NumberofSegment;
