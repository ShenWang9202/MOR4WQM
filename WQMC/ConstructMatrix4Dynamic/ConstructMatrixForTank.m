...
NodeTankVolume_Next = CurrentNodeTankVolume + delta_t.*CurrentNodeNetFlowTank./ConfigurationConstants.GPMperCFS;
...
A_TK = [];
q_B = q_B./ConfigurationConstants.GPMperCFS; % concert q_B from GPM to CFS
[NodeCount,~] = size(q_B);
...
for i = 1:TankCount
    ...
    CurrentTrueFlowPipe_Tank_i = TankMassMatrix(i,:).*CurrentFlow'./ConfigurationConstants.GPMperCFS;
