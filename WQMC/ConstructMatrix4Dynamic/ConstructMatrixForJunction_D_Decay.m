function [A_J_New, B_J_New]= ConstructMatrixForJunction_D_Decay(CurrentFlow,MassEnergyMatrix,flipped,ElementCount,IndexInVar,q_B,A_J,B_J,aux,JunctionDecayRate_step)
        ...
        if n == 0
            ...
            for j=1:n
                ...
                if(isPipe)
                    ...
                    A_J(i,lastSegmentIndex) = contributionC(i,Col(j));
					A_J(i,i) =  JunctionDecayRate_step; % make it decay a little bit to make A full rank and stable
                end
            end
        end
    end
