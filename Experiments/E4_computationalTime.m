...
%             end
            ...
            profile on
            [sysFull,ReducedsystemMatrix_BT,ReducedsystemMatrix_POD,ReducedsystemMatrix_BPOD,timeCost] = ModelReduction_computationalTime(FullSystemModel,ReductionParameter,tInMin);
