...
if ConfigurationConstants.POD
    ...
    rPOD = -1;
    ReducedsystemMatrix_POD = POD_Net3(PreviousSystemDynamicMatrix,delta_t,numofSteps,rPOD,EnergyPercentageGoal_POD);
...
if ConfigurationConstants.BPOD
    ...
    numofSteps = BPOD_Steps;%2000%900%500;%2*Np;
    rBPOD = -1;
    ReducedsystemMatrix_BPOD = BPOD_Net3(PreviousSystemDynamicMatrix,delta_t,numofSteps,rBPOD,EnergyPercentageGoal_BPOD);
...
disp(dispText)
% disp('loading impluse response for full model...')
% load('Net3TempAccuracyData.mat', 'Yfull')
% %Yfull = Yfull(1:3200,:,1);
% load('Net3TempAccuracyData.mat', 'YPOD')
% load('Net3TempAccuracyData.mat', 'YBPOD')
% load('Net3TempAccuracyData.mat', 'rBPOD')
% load('Net3TempAccuracyData.mat', 'rPOD')
% load('Net3TempAccuracyData.mat', 'nx')
