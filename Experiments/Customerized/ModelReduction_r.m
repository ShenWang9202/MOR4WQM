function [sysFull,ReducedsystemMatrix_BT,ReducedsystemMatrix_POD,ReducedsystemMatrix_BPOD]= ModelReduction_r(PreviousSystemDynamicMatrix,ReductionParameter,r_vector, tInMin,Network)
%% initialize
sysBT = [];
...
if ConfigurationConstants.BPOD
 ...
 plotOutputError_r_all(OutputError_L1_inputPerspective_BT,OutputError_L1_inputPerspective_POD,OutputError_L1_inputPerspective_BPOD,delta_t,r_vector,tInMin)
