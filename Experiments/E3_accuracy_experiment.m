...
switch Network
    ...
    case {5,6,7}
        ...
        EnergyPercentageGoal_BPOD = 99.958/100;
    ...
    case 9
        ...
        POD_Steps = 14000;
        DurationofResponseTested = 3200; %in seconds
        EnergyPercentageGoal_BT = 99.999999999995/100;
...
%             end
            ...
            profile on
            % impulse response for net1
%             [sysFull,ReducedsystemMatrix_BT,ReducedsystemMatrix_POD,ReducedsystemMatrix_BPOD,timeCost] = ModelReduction_accuracy(FullSystemModel,ReductionParameter,tInMin);
            % impulse response for net3
%             [sysFull,ReducedsystemMatrix_BT,ReducedsystemMatrix_POD,ReducedsystemMatrix_BPOD,timeCost] = ModelReduction_accuracy_Net3(FullSystemModel,ReductionParameter,tInMin);
            
            % step response for net1
             [sysFull,ReducedsystemMatrix_BT,ReducedsystemMatrix_POD,ReducedsystemMatrix_BPOD,timeCost] = ModelReduction_accuracy_Step(FullSystemModel,ReductionParameter,tInMin);
